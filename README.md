...
```bash
git clone [https://github.com/godninja69/Spotify-Telegram-Release-Bot.git](https://github.com/godninja69/Spotify-Telegram-Release-Bot.git)
...
1. Right-click `hidden_bot.vbs` and select **Create shortcut**.
2. Press `Win + R` on your keyboard, type exactly `shell:startup`, and press **Enter**.
3. A secret Windows Startup folder will open. Drag and drop the **shortcut** you just created into this folder.
4. The bot will now silently launch in the background every time you start your computer!